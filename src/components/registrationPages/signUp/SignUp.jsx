...
import { ReactComponent as IconGoogle } from '../../imgsForComponents/google-color-icon.svg';
import { ReactComponent as IconFacebook } from '../../imgsForComponents/facebook-color-icon.svg';
...
function SignUp() {
  ...
  return <div className="formBlock">
    ...
    <form className="formBlock__form" onSubmit={handleSubmit(onSubmit)}>
      ...
      {errors.name && <div className="formBlock__inp-indicator" role="alert">{errors.name?.message}</div>}
      ...
      {errors.email && <div className="formBlock__inp-indicator" role="alert">{errors.email?.message}</div>}
      ...
      {errors.password && <div className="formBlock__inp-indicator" role="alert">{errors.password?.message}</div>}
